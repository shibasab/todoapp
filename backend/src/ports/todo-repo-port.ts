...
import type { TodoDueDateFilter, TodoItem, TodoProgressStatus, TodoRecurrenceType } from '../domain/todo/types'
...
export type TodoRepoPort = Readonly<{
  ...
  findDuplicateActiveName: (ownerId: number, name: string, excludeId?: number) => Promise<TodoItem | null>
